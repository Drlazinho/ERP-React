...
import feedAmvox from '../../assets/feedAmvox.png';
...
export default function FeedbackModal({ nomeDaOS = '', prazoFinal = '00/00' }) {
  const [open, setOpen] = React.useState(false);
  const [formData, setFormData] = React.useState('');

  const prazoFinalDate = dateToTimestamp(prazoFinal);
  const dataAtual = Date.now();

  const isDateValid = prazoFinalDate > dataAtual;

  // useEffect(() => {
  //    const prazoFinalDate = dateToTimestamp(prazoFinal);
  //  const dataAtual = Date.now();

  //    if (dataAtual < prazoFinalDate) {
  ...
  const handleEnviarEmail = React.useCallback(() => {
    const data = new Date();
    const destinatario = 'inteligencia@amvox.com.br';
    const assunto = `FEEDBACK - O.S ${nomeDaOS}`;
    const body = ` <table
        align="center"
        role="presentation"
        cellspacing="0"
          ...
          <td>
            ...
            >
              <tbody>
                <tr>
                  <td style="width="25%">
                  <svg width="151" height="54" viewBox="0 0 201 54" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <tr>
                  ...
                  >
                    <tbody style="width: 100%">
                      <tr style="width: 100%"><p style="font-size: larger; font-weight: bold;">Feedback do Usuário</p></tr>
                      <tr style="width: 100%">
                        <td>
                          <p
                            style="
    ...
    <div>
      {isDateValid && (
        <Button
          ...
          onClick={handleOpen}
          style={{
            background: 'linear-gradient(45deg, #ac2929 30%, #272626 90%)',
          ...
          >
            ...
            <Box sx={{ width: '100%', p: 3 }}>
              ...
              <Typography
                ...
                color={'black'}
              >
                A sua opinião é muito importante para nós, pois nos ajuda a
                melhorar o nosso sistema. Por isso, gostaríamos de convidá-lo a
                nos dar um feedback sobre sua experiência conosco.
                <br />
                <br />
                Seu feedback pode ser sobre qualquer aspecto de sua experiência,
                seja o sistema, a entrega, etc.
              </Typography>
              ...
              >
                <Typography variant="body2">
                  Prazo para o feedback: {prazoFinal}
                </Typography>
                <Box
                  sx={{ display: 'flex', gap: 2, mt: 2, justifyContent: 'end' }}
                >
                  <Button
                    variant="contained"
                    color="error"
