...
export default function CardNotaProtocoloSelecionada({
      ...
      {listaDeNotasSelecionada.map((item) => (
        ...
        >
          <IconButton
            ...
            aria-label="Example"
            onClick={() => handleRemoveNotaNaLista(item.id)}
          >
          ...
          <Typography
            ...
            color={'black'}
          >
            Registro: {formatDateTime(item.datA_VENCIMENTO)}
          </Typography>
          <Divider light />
          <Typography
            variant="body2"
            ...
            color={'black'}
          >
            Vencimento: {formatDateTime(item.datA_VENCIMENTO)}
          </Typography>
        </Box>
      ))}
    </>
