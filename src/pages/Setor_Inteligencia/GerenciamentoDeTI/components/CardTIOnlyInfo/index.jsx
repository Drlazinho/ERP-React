...
export default function CardTIOnlyInfo({ endpointRef, bgColor, setor, color, infoUm, qtdInfoUm, infoDois, qtdInfoDois, icon }) {
    return (
        <Box sx={{ width: '100%', bgcolor: bgColor, borderRadius: 2.5, position: 'relative', display: 'flex', flexDirection: 'column', gap: 2 }}>
            ...
            <Box sx={{ display: 'flex', gap: 2, margin: 'auto', marginTop: 4 }}>
                <Box sx={{ display: 'flex', justifyContent: 'center', flexDirection: 'column', alignCenter: 'center' }}>
                    <Typography align='center' sx={{ color }}>{infoUm}</Typography>
                    <Typography align='center' sx={{ color }}>{qtdInfoUm ?? '---'}</Typography>
                </Box>
                <Divider orientation="vertical" variant="fullWidth" flexItem sx={{ width: 5, color: '#000', bgcolor: "#000" }} />
                <Box sx={{ display: 'flex', justifyContent: 'center', flexDirection: 'column', alignCenter: 'center' }}>
                    <Typography align='center' sx={{ color }}>{infoDois}</Typography>
                    <Typography align='center' sx={{ color }}>{qtdInfoDois ?? '---'}</Typography>
                </Box>
            </Box>
