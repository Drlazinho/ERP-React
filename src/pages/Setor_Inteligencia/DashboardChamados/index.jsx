...
import GraficoFechadoCategoria from './components/GraficoAbertoCategoria copy';
...
const chamadosFechados = [
  { title: 'Fechados em dia', value: 0, color: 'green' },
  { title: 'Fechados em atraso', value: 0, color: 'red' },
];
...
export default function DashboardChamados() {
  ...
  const [dataGraficoCategoria2, setDataGraficoCategoria2] = useState([]);
  ...
  const handleFetch = () => {
    DashboardCardsGet(filtro)
      .then((res) => {
        if (res) {
          ...
          setDataCard3([
            {
              title: 'Fechados em dia',
              value: fechadosEmDia || 0,
              color: 'green',
            },
            {
              title: 'Fechados em atraso',
              value: fechadosAtrasados || 0,
              color: 'red',
            },
          ]);
    ...
    GetChamadosGeral(filtro)
      .then((res) => {
        setDataGraficoCategoria2(res);
      })
      .catch((error) => {
        console.error('Erro ao buscar categorias:', error);
      });
  ...
  const handleDistribuicao = async () => {
    await DashboardDistribuicao(filtro).then((res) => {
        ...
        >
          ...
          >
            ...
            >
              ...
              <Button
                onClick={() => {
                  navigate('/inteligencia/geral/chamadosNovo');
                }}
                sx={{
                  display: 'flex',
                  borderRadius: '8px',
          ...
          >
            ...
            >
              ...
              <GraficoFechadoCategoria data={dataGraficoCategoria2} />
            </Box>
          ...
          >
            ...
            >
              <Box sx={{ width: '100%' }}>
                ...
                <ChamadosPorColaborador data={dataGraficoColaborador} />
              </Box>
            </Box>
          </Box>
        </Box>
