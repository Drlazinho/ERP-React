...
export default function CardChatHistorico({ dataCardDetalhe }) {
    ...
    <Box sx={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
      {dataCardDetalhe?.chamadosDetalhes?.map((detalhe) => (
        <Box
          ...
          sx={{
            bgcolor: detalhe.flag === 'Esquerda' ? '#F5F5F5' : '#FCF1E7',
            borderRadius: '16px',
            padding: '16px',
            width: '60%',
            alignSelf: detalhe.flag === 'Esquerda' ? 'flex-start' : 'flex-end',
          }}
        >
          <Box
            sx={{
