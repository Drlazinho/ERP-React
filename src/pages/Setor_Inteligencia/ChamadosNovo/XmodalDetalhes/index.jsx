...
export default function ModalDetalhes({
  ...
  const handleGetIdDetalhes = () => {
    GetChamadosDetalheId(idChamadoSel).then((res) => {
      setIdDetalhes(res);
    });
  };
          ...
          <form onSubmit={handleSubmitFormData}>
            ...
            <Box sx={{ display: 'flex', flexDirection: 'row', gap: 2, my: 2 }}>
              <TextField
                ...
                fullWidth
                value={
                  formDataDet.previsaoInicio
                    ? formDataDet.previsaoInicio.slice(0, 10)
                    : ''
                }
                name="previsaoInicio"
                onChange={(e) =>
              ...
              <TextField
                ...
                value={
                  formDataDet.previsaoEntrega
                    ? formDataDet.previsaoEntrega.slice(0, 10)
                    : ''
                }
                onChange={(e) =>
                  setFormDataDet((prev) => ({
