...
import { IAtendimentoResponse, IAtendimentoItem } from '../../types';
...
const TabelaWhatsApp: React.FC<TabelaWhatsAppProps> = ({
  loading,
  data = [],
}) => {
  const formatRowData = (item: IAtendimentoItem): TableData => ({
    ...
    percentualDeAtendimentosAvaliados:
      item.percentualDeAtendimentosAvaliados !== undefined &&
      item.percentualDeAtendimentosAvaliados !== null
        ? `${item.percentualDeAtendimentosAvaliados}%`
        : '0%',
